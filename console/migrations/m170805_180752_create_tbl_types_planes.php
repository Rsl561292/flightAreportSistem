...
class m170805_180752_create_tbl_types_planes extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%types_planes}}', [
            ...
            'wing_area' => $this->float()->unsigned()->notNull(),
            'width_chassis' => $this->float()->unsigned()->notNull(),
            'length_take_off' => $this->float()->unsigned()->notNull(),
            'length_landing' => $this->float()->unsigned()->notNull(),
            ...
            'count_crew' => $this->integer()->unsigned()->notNull(),
            'comment' => $this->text(),
