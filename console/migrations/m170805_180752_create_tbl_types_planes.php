...
class m170805_180752_create_tbl_types_planes extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%types_planes}}', [
            ...
            'max_take-off_mass' => $this->float()->unsigned()->notNull(),
            ...
            'max_number_seats' => $this->integer()->unsigned()->notNull()->defaultValue(0),
            'seats_business_class' => $this->integer()->unsigned()->notNull()->defaultValue(0),
            'count_crew' => $this->integer()->notNull()->unsigned()->defaultValue(2),
            'comment' => $this->text(),
